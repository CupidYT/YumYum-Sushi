...
export default function Cart() {
    return (
        <Link href="" className="group flex items-center gap-2 text-white bg-main no-underline h-11 px-5 rounded-full hover:text-main hover:bg-hover transition-colors">
            <p className="font-bold">0 mdl</p>
            <svg 
                width={20} 
                height={20} 
                fill="none"
                className="text-main group-hover:stroke-main transition-colors" 
